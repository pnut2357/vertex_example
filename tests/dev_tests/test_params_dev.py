...
def test_compile_pipeline():
    ...
    # assert isinstance(GCS_BUCKET_PATH, str), "Incorrect Type, Expected Type String"
    ...
    # assert isinstance(classification_target, str), "Incorrect Type, Expected Type String"
    # assert isinstance(label_name, str), "Incorrect Type, Expected Type String"
    # assert isinstance(UNIQUE_ID, str), "Incorrect Type, Expected Type String"
    # assert isinstance(GCS_BUCKET_PATH, str), "Incorrect Type, Expected Type String"
    assert isinstance(MLFLOW_IMAGE, str), "Incorrect Type, Expected Type String"
    # assert isinstance(TASK_CLASSIFICATION_TRAINING_DATA_PATH, str), "Incorrect Type, Expected Type String"
    # assert isinstance(TASK_CLASSIFICATION_ALL_DATA_PATH, str), "Incorrect Type, Expected Type String"
    assert isinstance(LATEST_NOSALES_MODEL_PATH, str), "Incorrect Type, Expected Type String"
    # assert isinstance(best_params, dict), "Incorrect Type, Expected Type Dict"
